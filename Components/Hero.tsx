...
const Hero = () => {
    return (
        <div className="hero bg-base-200 mt-5 md:mt-10 p-5">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <Image src="/working_color_choice.jpg" alt="working_color_choice" width={700} height={700} className="rounded-lg shadow-2xl" />
                <div>
